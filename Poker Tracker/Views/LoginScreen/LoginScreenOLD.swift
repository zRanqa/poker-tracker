...
struct LoginScreenOLD: View {
    ...
    let lightColor: Color = Color(red: 0.9, green: 0.9, blue: 0.9)
    let darkColor: Color = Color(red: 0.1, green: 0.1, blue: 0.1)
...
#Preview {
    LoginScreenOLD(onNavigate: { _ in })
}
