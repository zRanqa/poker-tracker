...
struct LoginScreen: View {
    ...
    func signup() {
        ...
        postRequest(to: API.createVerificationCode.url, jsonBody: jsonBody) { result in
            ...
            case .success(let response):
                ...
                if response.status == "success" {
                    // TODO: MOVE TO 6 DIGIT VERIFICATION
    ...
    func confirm_code() {
        ...
        postRequest(to: API.createAccount.url, jsonBody: jsonBody) { result in
            DispatchQueue.main.async {
                isLoading = false
            }
            switch result {
